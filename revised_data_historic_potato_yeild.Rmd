...
```{r}
dta <- read_csv("Documents/GitHub/PotatoAcerageAndYields/WA_potato_yield_revised.csv")
view(dta)
```
...
```{r}
summary(dta$Value) #summaries of the yeild values
```
...
#Need to manually add in Garfield county with 0 yeild (not included on original dataframe, did not have any potato acreage listed)
