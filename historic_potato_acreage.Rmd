...
dta[county_name == "COLUMBIA",] # what does (D) mean?- Not enough farms to enable anonymity (pg.X in doc Y)#Need to manually add in Garfield county with 0 acreage (not included on original dataframe, did not have any potato acreage listed)
```
### WA county map
```{r}
# Base WA county map
