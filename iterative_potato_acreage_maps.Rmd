...
```{r}
##Iterative year county maps: First take the code for the states and provinces surrounding WA (lines 119-124). Then add code for the WA county map using the first section of subset years (lines 125-140). Use facet_wrap (line 130) to create a map based on each year of data.
